...
<body>
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="col-md-12 card order-card">
                                        ...
                                        <div class="card-block front-icon-breadcrumb row align-items-end text-primary">
                                            <div class="breadcrumb-header col">
                                                ...
                                                <div class="d-inline-block col-md-8">
                                                    <h1 class="m-b-20 text-left"><b>BUSCADOR</b></h1>
                                                    <h6><i>Puedes realizar tus presupuestos y buscar tus equipos aqui</i></h6>
                                                ...
                                                <table id="tabla-seleccion" class="table table-responsive text-inverse table-bordered align-middle">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="col-md-3 text-center bg-c-lite-green text-inverse align-middle">MARCA & MODELO</th>
                                                            <th class="col-md-6 text-center bg-c-lite-green  text-inverse align-middle">DESCRIPCION</th>
                                        ...
                                        <!-- Tabla Computadoras -->
                                        <div class="table-responsive table-border-style container-fluid" id="tabla-computadoras">
                                            <h2 class="text-left text-inverse"><i>Computadoras</i></h2>
                                            <table class="table table-bordered text-inverse border-primary" id="tablab">
                                                <!-- ENCABEZADO -->
                                                <?php
                                                ...
                                                ?>
                                                    <thead>
                                                        <tr>
                                                            <th class="col-md-3 text-center bg-c-blue text-inverse align-middle">Imagen de Producto</th>
                                                            <th class="col-md-1 text-center bg-c-blue text-inverse align-middle">Tipo de Producto</th>
                                                            ...
                                                            <th class="text-center bg-c-blue text-inverse align-middle"><i class="ti-desktop"></i></th>
                                                        </tr>
                                                    </thead>
                                                    <!-- DATOS -->
                                                    <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center align-middle">
                                                                    <a class="btn-seleccionar">
                                                                        <label class="label label-success" title="Seleccionar" data-toggle="tooltip" data-placement="left"><i class="ti-plus text-center"></i></label>
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        <?php
                                        ...
                                        <div class="table-responsive" id="tabla-accesorios">
                                            ...
                                            <table class="table table-bordered text-inverse border-primary" id="tablac">
                                                <!-- ENCABEZADO -->
                                                <?php
                                                // Consulta los datos de la tabla
                                                $sql = "SELECT id, id_empresa, categoria, marca_modelo, descripcion, precio, fecha_reg, cantidad, imagen FROM accesorio";
                                                $resultado = mysqli_query($mysqli, $sql);
                                                // Si hay datos, crea la tabla HTML
                                                if (mysqli_num_rows($resultado) > 0) {
                                                ?>
    ...
    <script>
        ...
        function seleccionarFila(tablaOrigen, filaOrigen, tablaDestino) {
            ...
            for (var i = 0; i < datos.length; i++) {
                $("<td class='align-middle'>").text(datos[i]).appendTo(filaDestino);
            }
            // Agregar un botón de borrar a la nueva fila
            $("<td>").html(`<a class="btn btn-borrar"><i class="ti-close"></i></a>`).appendTo(filaDestino);
    ...
    <!-- Script para mostrar imagen expandida al hacer clic o pasar el cursor -->
    <script>
        var images = document.querySelectorAll('.expanded-image');
